...
@Component
public class FreemanAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {

    private final JWTDecoder jwtDecoder;

    @Value("${freeman.security.oauth2.redirectUri}")
    ...
    protected void handle(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        String token = jwtDecoder.generateToken(authentication);
